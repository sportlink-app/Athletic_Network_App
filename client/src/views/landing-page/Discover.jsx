...
function Discover() {
  return (
    <Container>
      <div
        className="absolute -top-52 left-2/3 transform-gpu blur-3xl sm:ml-16 opacity-20 md:opacity-35"
        aria-hidden="true"
      >
      ...
      <div className="relative bg-gradient-to-r from-cyan to-green mx-auto max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl rounded-3xl ring-1 ring-gray-200 p-8 sm:p-10 md:p-12 lg:p-14 xl:p-16 text-center text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-6 text-lg leading-8 ">
            ...
            enjoy sports together anytime, anywhere. Whether you're looking for
            a running buddy, a tennis partner, or a teammate for your next
