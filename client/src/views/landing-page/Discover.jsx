...
function Discover() {
  return (
    <Container>
      ...
      <div className="relative bg-gradient-to-r from-cyan to-green mx-auto max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl rounded-3xl ring-1 ring-gray-200 p-10 md:p-12 lg:p-14 xl:p-16 text-center text-white overflow-hidden">
        <img
