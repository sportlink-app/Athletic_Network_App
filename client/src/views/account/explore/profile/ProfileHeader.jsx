...
function ProfileHeader({ username, gender, availability }) {
  ...
  return (
    <div className="!w-1/2 lg:!w-1/3 xl:!w-1/5 self-center mt-4 md:mt-0 relative">
      <div className="absolute left-1/2 -top-4 lg:-top-5 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-3">
        <ProfileAvatar username={username} gender={gender} size={120} />
        <ul className="flex flex-col justify-center items-center gap-2 mt-2">
